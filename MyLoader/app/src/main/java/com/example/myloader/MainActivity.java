...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, AdapterView.OnItemClickListener {
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        if (id == CONTACT_LOAD){
            ...
            mCursorLoader = new CursorLoader(MainActivity.this, ContactsContract.CommonDataKinds.Phone.CONTENT_URI, phoneProjectionFields,
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        ...
        if (loader.getId() == CONTACT_LOAD) {
            ...
            if (PermissionAdapter.isGranted(this, Manifest.permission.CALL_PHONE)) {
